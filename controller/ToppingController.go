...
func CreateTopping(c *gin.Context, db *sql.DB) {
	...
	for _, topping := range toppings.Toppings {
		insertQuery := "INSERT INTO topping (Topping_name_th, Topping_name_en, Topping_price, Topping_Stock) VALUES (?, ?, ?, ?)"
		_, err := db.Exec(insertQuery, topping.Topping_name_th, topping.Topping_name_en, topping.Topping_price, topping.Topping_Stock)
		if err != nil {
...
func GetToppings(c *gin.Context, db *sql.DB) {
	...
	for rows.Next() {
		...
		err := rows.Scan(&topping.Topping_ID, &topping.Topping_name_th, &topping.Topping_name_en, &topping.Topping_price, &topping.Topping_Stock)
		if err != nil {
...
func GetTopping(c *gin.Context, db *sql.DB) {
	...
	var topping models.Topping
	err := db.QueryRow("SELECT * FROM topping WHERE Topping_ID = ?", toppingID).Scan(&topping.Topping_ID, &topping.Topping_name_th, &topping.Topping_name_en, &topping.Topping_price, &topping.Topping_Stock)
	if err != nil {
...
func UpdateTopping(c *gin.Context, db *sql.DB) {
	...
	_, err := db.Exec(updateQuery, topping.Topping_name_th, topping.Topping_name_en, topping.Topping_price, topping.Topping_Stock, id)
	if err != nil {
		log.Printf("Error executing query: %v", err)
